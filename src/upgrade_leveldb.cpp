        ...
        void try_upgrade_db(const boost::filesystem::path &dir, rocksdb::DB *dbase, const char *record_type, size_t record_type_size) {
            ...
            if (old_record_type != record_type) {
                ...
                if (upgrade_function_itr != upgrade_db_mapper::instance()._upgrade_db_function_registry.end()) {
                    ...
                    //elog("In ${db}, record types ${old} and ${new} do not match, but no upgrade function found!", ("db", dir.preferred_string())("old", old_record_type)("new", record_type));
                }
                ...
                //elog("In ${db}, record type matches ${new}, but record sizes do not match!", ("db", dir.preferred_string())("new", record_type));
