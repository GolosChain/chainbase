    ...
    namespace db {
        ...
        public:
            ...
            const object &get(object_id_type id) const {
                ...
                assert(maybe_found != nullptr);//, "Unable to find Object", ("id", id));
                return *maybe_found;
            }
            ...
            void modify(const Object &obj, const Lambda &l) {
                modify(static_cast<const object &>(obj),
                       std::function<void(object &)>([&](object &o) { l(static_cast<Object &>(o)); }));
            }
        ...
        public:
            ...
            virtual uint8_t object_space_id() const override { return object_type::space_id; }

            virtual uint8_t object_type_id() const override { return object_type::type_id; }
