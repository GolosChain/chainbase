    ...
    namespace db {
        ...
        public:
            ...
            virtual const object &insert(object &&obj) {
                ...
                assert(insert_result.second);//, "Could not insert object, most likely a uniqueness constraint was violated");
            ...
            virtual void modify(const object &obj, const std::function<void(object & )> &m) override {
                ...
                auto ok = _indices.modify(_indices.iterator_to(static_cast<const ObjectType &>(obj)),
                                          [&m](ObjectType &o) { m(o); });
                assert(ok);//, "Could not modify object, most likely a index constraint was violated");
            }
